(define (problem pb7)
   (:domain clutter)
   (:objects 
     table1--tabletop2 table2 table3 table4 - surface
   ...
   (:init 
          (on-surface bs1 table1--tabletop2) (on-surface bs2 table1--tabletop2) (on-surface bs3 table1--tabletop2) 
          (on-surface gs1 table1--tabletop2) (on-surface gs2 table1--tabletop2) (on-surface gs3 table1--tabletop2) (on-surface gs4 table1--tabletop2) 
          (on-surface rs1 table1--tabletop2) (on-surface rs2 table1--tabletop2) (on-surface rs3 table1--tabletop2) (on-surface rs4 table1--tabletop2) 
          (on-surface rs5 table1--tabletop2) (on-surface rs6 table1--tabletop2) (on-surface rs7 table1--tabletop2)
